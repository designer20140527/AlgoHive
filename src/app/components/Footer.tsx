      ...
      <div className="max-w-[1140px] mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://x.com/AlgoHive_COIN_" target="_blank" rel="noopener noreferrer" className="font-[family-name:var(--font-circular-book)] text-[#efe0ff]/70 hover:text-white transition-colors flex items-center gap-2">
